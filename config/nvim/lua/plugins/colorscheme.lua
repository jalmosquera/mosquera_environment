return {
  {
    ...
    },
    {
      "LazyVim/LazyVim",
      opts = {
        colorscheme = "tokyonight-night", -- "catppuccin-mocha" "catppuccin-frappe" "catppuccin-latte" "gruvbox-material" "gruvbox" "nord" "gentleman-kanagawa-blur" "oldworld" "kanagawa"
      },
    },
  },
}
